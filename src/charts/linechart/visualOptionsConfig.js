...
import { visualOptionsDateFormat, visualOptionsNumberFormat } from "../../constants";

export function getVisualOptionsConfig(mapping) {
    var customVisualOptions = visualOptions;
    customVisualOptions.xAxisFormat = axisFormat(visualOptions.xAxisFormat, mapping?.x?.mappedType);    
